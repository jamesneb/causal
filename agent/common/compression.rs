...
mod tests {
    ...
    fn test_compress_decompress() {
        ...
        assert!(compressed_max.len() <= compressed.len(), "Best compression should result in smaller or equal size");
    }
    ...
    fn test_compression_ratio() {
        ...
        assert!(ratio < 1.0, "Compression ratio should be less than 1.0 for compressible data");
        ...
        assert!(re_ratio >= 0.9, "Re-compressing already compressed data should not be beneficial");
    }
}
